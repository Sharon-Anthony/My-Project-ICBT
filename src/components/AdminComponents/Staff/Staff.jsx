...
function Staff() {
    ...
    const filteredUsers = users.filter(user => {
        ...
        const userIdStartsWithS = typeof user.userId === 'string' && user.userId.toLowerCase().startsWith('s');
        ...
        const phoneNumberMatch = typeof user.phoneNumber === 'number' && user.phoneNumber.toString().includes(lowerSearchTerm);
        const addressMatch = typeof user.address === 'string' && user.address.toLowerCase().includes(lowerSearchTerm);
    
        return userIdStartsWithS && (usernameMatch || emailMatch || passwordMatch || phoneNumberMatch || addressMatch);
    });
